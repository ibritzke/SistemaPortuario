...
<body>
	...
	<div class="menu">
		<ul class="mainmenu">
			...
			<li><a class="active" href="patio.php"><i class='fas fa-cubes fa-fw' style='font-size:18px'></i> Pátio</a></li>
	...
	<!--/Sidebar -->
	<!-- Patio -->
	<div class="relatoriodopatio">
		<?php

		$status_container = "Armazenado";
		$pt = $pdo->prepare("SELECT * FROM container where status_container = ? order by dth_entrada");
		$pt->execute(array($status_container));


		echo '<table class="table">';
		echo '<thead class="thead-dark"><tr><th>ID</th><th>MATRICULA</th><th>LOCAL ARMAZENADO</th><th>ORIGEM</th><th>DESTINO</th>
<th>DATA ENTRADA</th><th>STATUS</td></tr></thead>';
		foreach ($pt as $linha) {
    ...
    <td>' . $linha['status_container'] . '</td></tr>';
		}
		echo '</table>';
