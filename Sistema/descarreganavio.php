...
//php pra preparar a matricula do navio
$preparar = $pdo->query('SELECT Min(id_navio), matricula from navio');

foreach ($preparar as $linhas) {
	$_xxx['id_navio'] = $linhas[0];
	$matricula_navio['matricula'] = $linhas[1];
}
?>
...
<body>
	...
	<div class="remover">
		<br>
		<h6>Finalizar este navio? Volte e finalize <button a href="cadastrarnavio.php">Voltar</button></h6>
	</div>
